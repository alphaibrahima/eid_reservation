<div class="step" id="step-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <!-- ... Garde le même code pour la configuration ... -->
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <button onclick="decrementQuantity()" class="btn btn-outline-secondary">-</button>
                        <input type="number" class="form-control text-center" id="quantity" value="1" readonly>
                        <button onclick="incrementQuantity()" class="btn btn-outline-secondary">+</button>
                    </div>
